...
public class SQLiteMCSQLInterfaceTest {
    ...
    public void cipherDatabaseCreate(SQLiteMCConfig config, String dbPath, String key) throws SQLException {
        Connection connection = config.withKey(key).useSQLInterface(true).createConnection("jdbc:sqlite:" + dbPath);
    ...
    public Connection cipherDatabaseOpen(SQLiteMCConfig config, String dbPath, String key) throws SQLException {
        Connection conn = config.withKey(key).useSQLInterface(true).createConnection("jdbc:sqlite:" + dbPath);
        return conn;
    }
